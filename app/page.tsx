  ...
  <main className='w-screen h-screen relative'>
    <div className='flex items-center w-full h-full bg-cover bg-center' style={{backgroundImage: "url(main-bg.webp)"}}>
        <div className='pl-20 md:pl-40 pb-56 md:pb-20 flex flex-col gap-5 z-[10] max-w-[750px]'>
            ...
            Tôi đang tìm kiếm cơ hội thực tập cho bản thân. Mặc dù tôi chưa có nhiều kiến thức, 
            nhưng tôi tự hào về tinh thần học hỏi và cam kết nỗ lực để liên tục nâng cao kiến thức cá nhân. 
            Mong muốn của tôi là có được một cơ hội thực tập tại một tổ chức chuyên nghiệp, 
            nơi có thể đem lại trải nghiệm học tập thực tế và giúp tôi phát triển bản thân.
            </p>
